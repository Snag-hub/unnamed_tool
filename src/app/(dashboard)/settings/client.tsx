                ...
                <div className="p-3 sm:p-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-900/50 rounded-xl border border-zinc-100 dark:border-zinc-800 gap-4 sm:gap-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0">
                                <h3 className="font-medium text-zinc-900 dark:text-white truncate">Google Calendar</h3>
                                <p className="text-sm text-zinc-500 dark:text-zinc-400 break-words">Import upcoming events to your timeline</p>
                            </div>
                        </div>
                        <button
                            onClick={async () => {
